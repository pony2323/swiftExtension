...
class Common: NSObject {
    ...
    // MARK: 判断订单状态
    static func judgeOrderState(_ state:String) -> String {
        switch state {
            case "createnew":
            return orderState.createnew.rawValue
        case "confirmed":
            return orderState.confirmed.rawValue
        case "deliveried":
            return orderState.deliveried.rawValue
        case "payed":
            return orderState.payed.rawValue
        case "canceled":
            return orderState.canceled.rawValue
        default:
            return ""
        }
    }
